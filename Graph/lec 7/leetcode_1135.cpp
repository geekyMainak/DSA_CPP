...
You are given an array connections, where:Each connections[i] = [a, b, cost]
means that there is a road between cities a and b, and building this road costs cost.
You must connect all cities so that every city is reachable from any other city.
